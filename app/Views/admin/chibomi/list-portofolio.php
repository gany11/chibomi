...
<head>
     <?php echo view("admin/partials/title-meta", array("title" => "List Portofolio")) ?>
...
<body>
     ...
     <div class="wrapper">
          ...
          <?php echo view("admin/partials/topbar", array("title" => "List Portofolio")) ?>
               ...
               <div class="container-xxl">
                    ...
                    <div class="row">
                         <div class="col-xl-12">
                              ...
                              $buttons = '<button class="btn btn-sm btn-soft-primary m-1" onclick="window.location.href=\'/admin/portofolio/detail/'.$item['id_portofolio'].'\'">Detail</button>';
                              ...
                              if ($item['drafted_at']) {
                                   ...
                                   if ($sessionRole === 'Pemilik') {
                                        $buttons .= '<button class="btn btn-sm btn-soft-success m-1" onclick="restorePortofolio(\''.$item['id_portofolio'].'\')">Pulihkan</button>';
                                        $buttons .= '<button class="btn btn-sm btn-soft-danger m-1" onclick="deletePortofolio(\''.$item['id_portofolio'].'\')">Hapus</button>';
                                   }
                              } else {
                                   ...
                                   $buttons .= '<button class="btn btn-sm btn-soft-warning m-1" onclick="archivePortofolio(\''.$item['id_portofolio'].'\')">Arsipkan</button>';
                              }
                              ...
                              document.addEventListener("DOMContentLoaded", function () {
                                   const portofolio = <?= json_encode($portofolio, JSON_UNESCAPED_UNICODE) ?>;
                              ...
                              function archivePortofolio(id_portofolio) {
                                   Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                             fetch('/portofolio/archive', {
                                                  method: 'POST',
                                                  headers: {
                                                  'Content-Type': 'application/json',
                                                  },
                                                  body: JSON.stringify({ id_portofolio: id_portofolio })
                                             })
                              ...
                              function restorePortofolio(id_portofolio) {
                                   Swal.fire({
