<div class="col-lg-4">
    <div class="ltn__tab-menu-list mb-50">
        <div class="nav">
            <?php if (session()->has('id_account') && (session()->has('role') == 'Pemilik')): ?>
            <a <?=$title === 'Pesanan Saya' ? 'class="active show"' : '';?> href="<?= base_url('/pesanan') ?>">Pesanan Saya <i class="fas fa-file-alt"></i></a>
