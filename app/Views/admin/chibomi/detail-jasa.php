...
<head>
    <?php echo view("admin/partials/title-meta", array("title" => "Detail Jasa")) ?>
    <?= $this->include("admin/partials/head-css") ?>
</head>

<body>
<div class="wrapper">
    <?php echo view("admin/partials/topbar", array("title" => "Detail Jasa")) ?>
        ...
        <div class="container-xxl">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <h4><?= esc($jasa['nama_produk']) ?> <span class="fs-14 text-muted ms-1">(<?= esc(!empty($jasa['kategori'])? $jasa['kategori'] : '-')?>)</span></h4>
                ...
                <div class="col-xl-9 col-lg-8 ">
                    <form action="<?= base_url('admin/jasa/detail/save/' . $jasa['id_product']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tambah Foto Jasa</h4>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="kategori" class="form-control <?= isset($errors['kategori']) ? 'is-invalid' : '' ?>" name="kategori" value="<?= old('kategori', $jasa['kategori'] ?? '') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="deskripsi-editor" style="height: 300px;">
                                        <?= old('deskripsi', $jasa['deskripsi'] ?? '') ?>
                                    </div>
                                    <input type="hidden" name="deskripsi" id="deskripsi" value="<?= esc(old('deskripsi', $jasa['deskripsi']) ?? '') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="tag" data-choices data-choices-text-unique-true class="form-control <?= isset($errors['tag']) ? 'is-invalid' : '' ?>" name="tag" value="<?= old('tag', $jasa['tag'] ?? '') ?>">
